                ...
                <div className='w-full flex flex-col mt-12 max-w-[650px]'>
                    ...
                    */}
                    ...
                    <div className='w-full flex items-center justify-center'>
                        <p className='text-sm font-normal text-[#060606]'>Dont have a account? <span className='font-semibold '><NavLink to='/signup' className='underline underline-offset-2 cursor-pointer'>Sign up</NavLink> for free</span></p>
                    </div>
